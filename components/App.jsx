  ...
  return (
    <div style={appStyles.chrome} data-screen-label={`Talksmith — ${screen}`}>
      ...
      {idle && screen === 'live' && !micMode ? (
        <IdleState onStart={() => setIdle(false)} onReview={() => setScreen('review')}
...
function IdleState({ onStart, onReview, onRecord, unsupported }) {
  return (
      ...
      <div style={{ maxWidth: 420, textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 13, color: 'var(--ink-2)', lineHeight: 1.5 }}>
            Record a meeting from your microphone for live coaching and a scored review, or play a demo meeting.
          </div>
        </div>
